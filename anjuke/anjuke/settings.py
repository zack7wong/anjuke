...
DOWNLOAD_DELAY = 0.8
DOWNLOAD_TIMEOUT = 16 # 默认值：180 下载器在超时前等待的时间量（以秒为单位）。
...
#     # 'scrapy.contrib.downloadermiddleware.retry.RetryMiddleware': 80, # 废弃
...
# Scrapy会缓存你有的Requests!当你再次请求时，如果存在缓存文档则返回缓存文档，而不是去网站请求，这样既加快了本地调试速度，也减轻了 网站的压力。一举多得
...
MY_PROXY = [
    '36.32.45.194:6436',
    '61.134.51.71:1246',
    '113.138.208.174:1448',
    '117.87.157.14:2837',
    '42.242.117.206:6843',
    '175.150.239.189:2589',
    '121.233.89.160:6511',
    '124.152.85.5:3012',
    '112.122.213.201:4212',
    # '112.252.71.97:4274]',
]
